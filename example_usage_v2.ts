...
import { Product } from './src/features/compare/v2/types.ts';
...
const watchCategory = CATEGORY_CONFIGS['sports_watch'];
const watchResult = SmartComparisonEngine.compare(watches, watchCategory.metrics, undefined);
