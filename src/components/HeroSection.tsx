  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-primary">
        ...
        <div className="max-w-4xl space-y-10">
          <div className="space-y-6">
            ...
            <div className="relative">
              <h1 className="font-heading text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold text-primary-foreground leading-[1.1] md:leading-[0.9] tracking-tight-compact animate-in fade-in slide-in-from-bottom-20 duration-700 delay-100 fill-mode-both">
                GEAR FOR <br className="hidden sm:block" />
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 text-primary-foreground/40 animate-bounce">
        <span className="text-[10px] uppercase font-semibold tracking-sporty">Scroll</span>
